...
<link rel="stylesheet" href="inc/styles/info.css">
    ...
    <section id="services">
        <h2>¿Qué nos avala?</h2>
        <ul>
            <li>Años de experiencia en el sector 🥼🧪</li>
            <li>Clientes que vuelven 💕 (¿seguimos aquí, no?)</li>
            <li>Nos desplazamos 🚗 (No nos importa ir a echarte una mano) y darte un presupuesto sin compromiso.</li>
